...
\subsection{Menjalankan Image sebagai Container}
...
\begin{lstlisting}[language=bash, style=phphtml]
docker run -d -p 8081:8080 --env-file .env --name jwt-container php-jwt-example
\end{lstlisting}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../images/run-image.png}
    \caption{Menjalankan Image sebagai Container dengan perintah docker run}
    \label{fig:run-container}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{../images/docker-ps-a.png}
    \caption{Melihat daftar Container yang sedang berjalan}
    \label{fig:ps-container}
\end{figure}

\subsection{Cek aplikasi di Browser}
Setelah menjalankan container, dan melihat statusnya sudah up, praktikan dapat mengakses aplikasi di browser dengan alamat http://10.33.35.71:8081. Jika aplikasi berjalan dengan baik, maka akan muncul tampilan seperti pada gambar \ref{fig:app-container}:
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../images/8081.png}
    \caption{Tampilan aplikasi berjalan dengan baik di dalam Container}
    \label{fig:app-container}
\end{figure}

\subsection{Uji di Postman}
...
\begin{figure}[H]
    ...
    \caption{Uji API register dengan Postman}
    \label{fig:postman}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Uji API login dengan Postman}
...
\begin{figure}[H]
    ...
    \caption{Uji API users dengan Postman}
    \label{fig:postman-users}
\end{figure}
